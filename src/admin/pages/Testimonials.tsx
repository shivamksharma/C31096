...
const testimonials = [
  {
    ...
    content: 'EDIF Pharma\'s cardiovascular treatments have significantly improved patient outcomes in our practice. The quality and efficacy are outstanding.',
    rating: 5,
    status: 'Approved',
  ...
  },
  {
    ...
    content: 'The neurological medications from EDIF Pharma have shown remarkable results in treating complex conditions. Highly recommended.',
    rating: 5,
    status: 'Pending',
  ...
  },
  {
    ...
    role: 'Patient',
    organization: 'N/A',
    content: 'The treatment I received has changed my life. Thank you EDIF Pharma for the hope and recovery.',
    rating: 5,
    status: 'Rejected',
