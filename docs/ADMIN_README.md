# PharmaCorp Admin Panel

A premium, modern admin panel for managing PharmaCorp's public website content and data.
...
Built with ❤️ for PharmaCorp's content management needs.